...
import { removeFav } from '../redux/moviereview/action';
...
const FavCard = (props) => {
    ...
    const favButtonText= favlistitem ? "Added" : "Add Fav";
        ...
        <>
            ...
            <div  className="rating">
                ...
                <div className='card-img'>
                    <img src={`${img_500}/${props.poster}`} alt='card image'/>
                </div>
                ...
                <div className="remove-fav">
                    <Button size="sm" variant='outline-dark' onClick={()=>{dispatch(removeFav(props.id))}} > <HighlightOffIcon /> </Button>
                </div>
              <span>  <div className="review-btn">
                    <Button size="sm" size="small" variant='outline-success' onClick={handleOpen}>  
